...
// =================Part 1=======================
// can't use a const should have used let
//  const globalVar = "Counter";
...
//  Counter(2)
 ...
 function increment() {
    // try and catch moving the counter and increment to inside
    try{
        counter++
    increment();
    }catch (e){
...
const factorial = (n) => {
   ...
   */
  console.log(trampoline(facto(10000))) // output infinity